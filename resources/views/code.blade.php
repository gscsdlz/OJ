...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-success">
            ...
            <div class="panel-body"><pre class="line-numbers command-line data-line"><code class="language-@if($submitInfo->lang == 1)c" @elseif($submitInfo->lang == 2)cpp" @elseif($submitInfo->lang == 3)java" @endif style="font-size: 18px;">{{ $code->code }}</code></pre></div>
        </div>
    </div>
</div>
@endsection
